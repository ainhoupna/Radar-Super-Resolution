...
SCALE_FACTOR = 2       
N_RESBLOCKS = 32       # Increased from 16 to 32
N_FEATS = 64           
RES_SCALE = 0.1        

BATCH_SIZE = 64        # Reduced batch size to accommodate deeper model in VRAM
LEARNING_RATE = 1e-4   
EPOCHS = 100           
PATIENCE = 7           # Requested patience
ALPHA_SSIM = 0.2      
...
def main():
    ...
    # Updated RUN_NAME to include Experiment 5 details
    RUN_NAME = f"edsr_x{SCALE_FACTOR}_depth32_p{PATIENCE}_{timestamp}"
    ...
    print("Training Experiment 5 (Depth 32) Complete.")
