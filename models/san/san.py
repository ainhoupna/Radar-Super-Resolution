...
class SAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        # RGB mean for DIV2K (adjusted for n_colors)
        if args.n_colors == 3:
            rgb_mean = (0.4488, 0.4371, 0.4040)
            rgb_std = (1.0, 1.0, 1.0)
        else:
            rgb_mean = (0.5,) * args.n_colors
            rgb_std = (1.0,) * args.n_colors
        self.sub_mean = common.MeanShift(args.rgb_range, rgb_mean, rgb_std, n_colors=args.n_colors)
        ...
        self.add_mean = common.MeanShift(args.rgb_range, rgb_mean, rgb_std, 1, n_colors=args.n_colors)
